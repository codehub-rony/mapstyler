<template>
  <div class="dataset-container mb-2">
    <div v-for="(layer, i) in layers" :id="i" class="mb-1 pl-4">
      <div class="d-flex flex-row align-center justify-space-between pl-2 pr-2">
        ...
        <div class="d-flex flex-row">
          <EditButton :layer="layer" @open-edit-dialog="handleEvent" />
